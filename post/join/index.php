<!DOCTYPE html>
<link rel="stylesheet" type="text/css" href="../post/join/style.css">
...
session_start();
    if (!empty($_POST)) {
        ...
        if (empty($error)) {
            $image = date('YmdHis') . $_POST['image']['name'];
            move_uploaded_file($_FILES['iamge']['tmp_name'], '../member_picture/' . $image);
            $_SESSION['join'] = $_POST;
...
<form action="" method="POST" enctype="multipart/form-data">
    <dl>
        ...
        <dt>写真など</dt>
        <dd><input type="file" name="image" size="35" maxlength="255" />
