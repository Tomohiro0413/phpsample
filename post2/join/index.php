...
session_start();
    if (!empty($_POST)) {
        ...
        if (empty($error)) {
            ...
            move_uploaded_file($_FILES['image']['tmp_name'], '../mamber_picture/' .$image);
            $_SESSION['join'] = $_POST;
...
<form action="" method="post" enctype="multipart/form-data">
    <dl>
        ...
        <dd><input type="password" name="password" name="password" size="10" maxlength="20" value="<?php echo htmlspecialchars($_POST['password'], ENT_QUOTES); ?>" >
        ...
        <dd><input type="file" name="image" size="35" />
            ...
            <?php endif;?>
            <?php if (!empty($error)): ?>
            <p class="error">＊恐れ入りますが、画像を改めてしてしてください。</p>
            <?php endif; ?>
        </dd>    
    </dl>
